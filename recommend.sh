...
sudo pacman -S xorg-server xorg-apps xorg-server
...
sudo pacman -S  plasma-desktop sddm plasma xdg-user-dirs ffmpegthumbs
sudo systemctl enable sddm.service
sudo systemctl enable NetworkManager.service

sudo pacman -Sy archlinux-keyring 

cp applications.sh yay_packages blacklistnouveau.conf /home/matrix
su matrix
